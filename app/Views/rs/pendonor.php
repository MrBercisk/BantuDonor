                    ...
                    <div class="modal fade text-left" id="modalTambahStok" tabindex="-1" aria-labelledby="modalTambahStokLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="<?= base_url('pendonor/create'); ?>" method="post">
                                        <div class="mb-3">
            ...
            <tbody>
                <?php foreach ($pendonor as $index => $donor) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url('pendonor/show/' . $donor['id']); ?>" class="btn btn-primary btn-sm"><i class="fas fa-pencil"></i></a>
                            <a href="<?= base_url('pendonor/delete/' . $donor['id']); ?>" class="btn btn-danger btn-sm delete-btn"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
